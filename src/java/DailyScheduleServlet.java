 ...
 */
@WebServlet(urlPatterns = {"/servlets/DailyScheduleServlet"})
public class DailyScheduleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //out.println("<DIV class=\"head\">Facebook</DIV>");
...
"</nav>");
            ...
            //Place Shcedule Data in the page
            try
            {
                ...
                if(database.examStatus())
                {
                    ...
                    out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Today's Exam Schedule</DIV></DIV>");
                    out.println("<DIV class=\"row\"><br/></DIV>");
                    
                    ResultSet set=database.examSchedule(userID);
                    while(set.next())
                    {
                        //Subject
                        out.println("<DIV class=\"row\">");
                ...
                //If normal schedule is in progress
                else
                {
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Today's Schedule</DIV></DIV>");
                    out.println("<DIV class=\"row\"><br/></DIV>");
                    
                    ResultSet set=database.routineSchedule(userID);
                    while(set.next())
                    {
                        //Subject Code
                        out.println("<DIV class=\"row\">");
