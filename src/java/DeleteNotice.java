 ...
 * @author Shoaib Ahmed
 */
@WebServlet(urlPatterns = {"/servlets/admin/DeleteNotice"})
public class DeleteNotice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            database.removeNotice(noticeID);
            response.sendRedirect("/SEECS_Portal/servlets/admin/AdminNoticeBoardServlet");
