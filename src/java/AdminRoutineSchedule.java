 ...
 * @author Shoaib Ahmed
 */
@WebServlet(urlPatterns = {"/servlets/admin/AdminRoutineSchedule"})
public class AdminRoutineSchedule extends HttpServlet {
...
"</nav>");
            ...
            out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Routine Schedule</DIV></DIV>");
            ...
            try
            {
                ResultSet set=database.getCompleteRoutineSchedule();
                while(set.next())
                {
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Class :</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(1)+"</DIV>");
                    out.println("</DIV>");
                    
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Subject :</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(3)+"</DIV>");
                    out.println("</DIV>");
                    
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Day :</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(4)+"</DIV>");
                    out.println("</DIV>");
                    
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Timeslot :</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(5)+"</DIV>");
                    out.println("</DIV>");
                    
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Class Room #</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(6)+"</DIV>");
                    out.println("</DIV>");
                    ...
                    //Save the date for deletion
                    out.println("<input type=\"hidden\" name=\"class\" value="+set.getString(1)+">");
                    out.println("<input type=\"hidden\" name=\"day\" value="+set.getString(4)+">");
                    out.println("<input type=\"hidden\" name=\"timeslot\" value="+set.getString(5)+">");
                        
                    //Create Delete Link
                    out.println("<BUTTON type=\"submit\" class=\"btn btn-default\" formaction=\"http://localhost:8080/SEECS_Portal/servlets/admin/DeleteScheduleData\">");
