 ...
 */
@WebServlet(urlPatterns = {"/servlets/SportsServlet"})
...
"</nav>");
            ...
            try
            {
                ResultSet set=database.sportsGoods();
                while(set.next())
                {
                    //Item
                    out.println("<DIV class=\"row\">");
                    ...
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">");
                    out.println("Availability : </DIV>");
                    out.println("<DIV class=\"col-md-3\">");
                    out.println(set.getString(2));
                    out.println("</DIV>");
                    out.println("</DIV>");
                    
                    //If Item not available then display the registration number of the student who issued the item
                    if(set.getString(2).equals("N"))
                    {
                        //Registration Number
                        out.println("<DIV class=\"row\">");
                        out.println("<DIV class=\"col-md-3\"></DIV>");
