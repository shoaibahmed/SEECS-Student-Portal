 ...
 * @author Shoaib Ahmed
 */
@WebServlet(urlPatterns = {"/servlets/admin/AdminNoticeBoardServlet"})
...
"</nav>");
            ...
            out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Notice Board</DIV></DIV>");
            ...
            out.println("<FORM>");
            out.println("<BUTTON type=\"submit\" class=\"btn btn-default\" formaction=\"http://localhost:8080/SEECS_Portal/AddNotice.html\">");
            out.println("<span class=\"glyphicon glyphicon-plus\"></span> Add New Notice</BUTTON>");
            out.println("</FORM>");
            out.println("</DIV></DIV>");
            ...
            try
            {
                ResultSet set=database.getAllNotices();
                while(set.next())
                {
                    out.println("<FORM>");
                    
                    //Save the MessageID
                    out.println("<input type=\"hidden\" name=\"noticeID\" value="+set.getString(1)+">");
                    ...
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">");
                    out.println("<BUTTON type=\"submit\" class=\"btn btn-default\" formaction=\"http://localhost:8080/SEECS_Portal/servlets/admin/DeleteNotice\">");
