 ...
 * @author Shoaib Ahmed
 */
@WebServlet(urlPatterns = {"/servlets/admin/AdminPageServlet"})
...
"</nav>");
            ...
            out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Approve New Users</DIV></DIV>");
            ...
            try
            {
                ResultSet set=database.readAllTempUserData();
                while(set.next())
                {
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
...
"    				<h4 class=\"media-heading\">");
                    ...
                    out.println("<input type=\"hidden\" name=\"tempUserID\" value="+set.getString(1)+">");
                        
                    //Create Approve Link
                    out.println("<BUTTON type=\"submit\" class=\"btn btn-default\" formaction=\"http://localhost:8080/SEECS_Portal/servlets/admin/ApproveUser\">");
                    out.println("<span class=\"glyphicon glyphicon-pencil\"></span> Mark as Approved</BUTTON>");
