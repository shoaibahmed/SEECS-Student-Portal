 ...
 * @author Shoaib Ahmed
 */
@WebServlet(urlPatterns = {"/servlets/admin/AdminExamSchedule"})
public class AdminExamSchedule extends HttpServlet {
...
"</nav>");
            ...
            out.println("<DIV class=\"col-md-6\" style=\"text-align: center; background-color: black; color: white\">Exam Schedule</DIV></DIV>");
            ...
            try
            {
                ResultSet set=database.getCompleteExamSchedule();
                while(set.next())
                {
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Registration #</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(1)+"</DIV>");
                    out.println("</DIV>");
                    
                    out.println("<DIV class=\"row\">");
                    out.println("<DIV class=\"col-md-3\"></DIV>");
                    out.println("<DIV class=\"col-md-3\">Date :</DIV>");
                    out.println("<DIV class=\"col-md-3\">"+set.getString(2)+"</DIV>");
                    out.println("</DIV>");
                    ...
                    out.println("<input type=\"hidden\" name=\"regNo\" value=\""+set.getString(1)+"\">");
                    out.println("<input type=\"hidden\" name=\"timeslot\" value=\""+set.getString(4)+"\">");
                    out.println("<input type=\"hidden\" name=\"date\" value=\""+set.getString(2)+"\">");
